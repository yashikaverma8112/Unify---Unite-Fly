...
export default function SignUp() {
  ...
  const AUTH_SIGNUP = process.env.REACT_APP_AUTH_SIGNUP;
  ...
  return (
    <div className="absolute inset-0 flex flex-col justify-center items-center min-h-screen" style={{ top: '4rem' }}>
